...
# from ada_verona.verification_module.abcrown_module import abcrownModule
...
if __name__ == "__main__":
    ...
    eps_list = np.arange(0.001, 0.4, 0.002)
    verifier = SymphonyModule(timeout=3600, symphony_path="/home/annelot/coinbrew/SYMPHONY/SYMPHONY/Examples/milp")
    # verifier = abcrownModule(timeout=3600, config = Path("/home/annelot/example_config.yaml"))
